...
export default function HeroMesh() {
  return (
    <section className="relative pt-10 sm:pt-16 pb-12 sm:pb-20 overflow-hidden w-full max-w-full">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-4 sm:pt-8 w-full max-w-full">
        {/* Subdued Indigo Tag */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-pill bg-primary-subdued/70 text-primary-deep text-[11px] sm:text-[12px] font-medium tracking-wide mb-5 border border-primary-subdued shadow-sm max-w-[90%]">
          <Zap className="w-3.5 h-3.5 text-primary shrink-0" />
          <span className="truncate">Candidate Line-Up &amp; Interview Command</span>
        </div>

        {/* Editorial Display Headline */}
        <h1 className="text-2xl xs:text-3xl sm:text-5xl lg:text-[56px] font-light leading-[1.12] tracking-display-lg sm:tracking-display-xxl text-ink max-w-4xl mx-auto mb-4 sm:mb-6 px-1">
          The daily recruitment line-up engine for high-velocity teams.
        </h1>

        {/* Marketing Lead Body */}
        <p className="text-xs sm:text-[18px] font-light leading-relaxed text-ink-secondary max-w-2xl mx-auto mb-8 sm:mb-10 px-2">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-3 sm:gap-4 mb-10 sm:mb-14 max-w-xs sm:max-w-none mx-auto w-full px-2">
          <Link
            href="/admin"
